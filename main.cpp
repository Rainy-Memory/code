...
namespace RainyMemory {
    ...
    namespace sort_assist {
        ...
        void _intro_sort_loop(RandomAccessIterator first, RandomAccessIterator last, Size depth_limit) {
            while (last - first > _threshold) {
                ...
                _intro_sort_loop(cut, last, depth_limit);
                last = cut;
            }
        }
        ...
        void _final_insertion_sort(RandomAccessIterator first, RandomAccessIterator last) {
            if (last - first > _threshold) {
                ...
                _unguarded_insertion_sort(first + _threshold, last);
            }
    ...
    inline void sort(RandomAccessIterator first, RandomAccessIterator last) {
        if (first != last) {
            sort_assist::_intro_sort_loop(first, last, sort_assist::_lg(last - first) * 2);
